...
int codegen_declaration(struct node *declaration, struct symbol_list* scope, int print_flag);
int codegen_if(struct node *if_statement, struct symbol_list* scope, int print_flag);
int codegen_while(struct node *while_statement, struct symbol_list* scope, int print_flag);
int codegen_return(struct node *return_statement, struct symbol_list* scope, int print_flag);
